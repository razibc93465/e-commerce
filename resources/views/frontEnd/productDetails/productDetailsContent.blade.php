...
$(window).load(function () {
    $('.flexslider').flexslider({
        ...
        controlNav: "thumbnails"
                    ...
                    <!-- //FlexSlider-->
                    <ul class="slides">
                        @foreach($productById as $publishedCategoryProduct)
...
<!--                        <li data-thumb="{{asset($productById->productImage)}}">
        ...
        <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
            ...
            <div class="occasion-cart">
                <a href="{{url('/cart/add')}}" class="item_add hvr-outline-out button2">Add to cart</a>
            </div>
...
<!--                        <p>Raw denim  apparel, butcher voluptate nisi qui.
                            <span>Duis aute  </span></p>-->
